...
export type PlatformMapper = {
  ...
  mapAPITrackTimestamp?: (trackItem: unknown) => bigint;
  mapArtistProfile: (artistItem: any, createdAtTimestamp: bigint, createdAtEthereumBlockNumber?: bigint) => ArtistProfile;
}
