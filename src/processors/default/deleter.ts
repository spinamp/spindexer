...
//   await clients.db.delete(Table.erc721nfts, metadataIdsForDelete, 'metadataId');
//   await clients.db.delete('metadatas', metadataIdsForDelete);
//   console.log('Deleted');
// };

const deleteRecords = (tableName:Table, processorName:string) => async (ids: string[], clients: Clients) => {
...
export const stripIgnoredNFTs: Processor = {
  ...
  trigger: ignoredNFTs,
  processorFunction: deleteRecords(Table.erc721nfts, 'stripIgnoredNFTs'),
  initialCursor: undefined
};
