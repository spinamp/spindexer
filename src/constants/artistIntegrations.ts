...
const DANIEL_ALLAN_GLASSHOUSE_FACTORY: NftFactory = {
  ...
  typeMetadata: {
    overrides: {
      artist: {
        name: 'Daniel Allan',
        artistId: evmId(ethereumChainId, '0xbcefc4906b443e4db64e2b00b9af2c39e76c785c'),
...
const JAGWAR_TWIN_THOUGHT_FORMS_NFT_FACTORY: NftFactory = {
  ...
  typeMetadata: {
    overrides: {
      ...
      artist: {
        name: 'Jagwar Twin',
        artistId: evmId(ethereumChainId, jagwarTwinAddress),
...
const MIGHTY_33_OTHERS_DIE_FACTORY: NftFactory = {
  ...
  typeMetadata: {
    overrides: {
      artist: {
        name: 'Mighty33',
        artistId: evmId(ethereumChainId,mighty33Address),
