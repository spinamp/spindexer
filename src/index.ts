...
import { ipfsFileSyncExistingUploadsProcessor } from './processors/ipfsFile/mediaSyncProcessor';
...
import { processedTrackUrlSync } from './processors/processedTrack/urlSyncProcessor';
...
const PROCESSORS = (
  ...
  return [
    ...
    processedTrackUrlSync('lossyArtwork'),
    processedTrackUrlSync('lossyAudio'),
